# Infrastructure Modeling Engine (IME) - Design Document
...
1.  **Modeling Engine (Core)**
2.  **Compiler**
3.  **UI Layer**

### High-Level Flow:
User interacts with UI → UI updates IR → Validation engine runs → Compiler generates Terraform → Preview shown → Export project
